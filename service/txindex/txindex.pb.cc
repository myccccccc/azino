...
void protobuf_AssignDesc_service_2ftxindex_2ftxindex_2eproto() {
  ...
  static const int ReadRequest_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ReadRequest, lock_),
  };
...
void protobuf_AddDesc_service_2ftxindex_2ftxindex_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\0132\021.azino.TxOpStatus\"K\n\013ReadRequest\022!\n\004"
    "txid\030\001 \001(\0132\023.azino.TxIdentifier\022\013\n\003key\030\002"
    " \001(\t\022\014\n\004lock\030\003 \001(\010\"T\n\014ReadResponse\022\'\n\014tx"
    "_op_status\030\001 \001(\0132\021.azino.TxOpStatus\022\033\n\005v"
    "alue\030\002 \001(\0132\014.azino.Value2\377\002\n\013TxOpService"
    "\022T\n\013WriteIntent\022!.azino.txindex.WriteInt"
    "entRequest\032\".azino.txindex.WriteIntentRe"
    "sponse\022N\n\tWriteLock\022\037.azino.txindex.Writ"
    "eLockRequest\032 .azino.txindex.WriteLockRe"
    "sponse\022B\n\005Clean\022\033.azino.txindex.CleanReq"
    "uest\032\034.azino.txindex.CleanResponse\022E\n\006Co"
    "mmit\022\034.azino.txindex.CommitRequest\032\035.azi"
    "no.txindex.CommitResponse\022\?\n\004Read\022\032.azin"
    "o.txindex.ReadRequest\032\033.azino.txindex.Re"
    "adResponseB\003\200\001\001", 1175);
...
const int ReadRequest::kLockFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
// optional bool lock = 3;
bool ReadRequest::has_lock() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
void ReadRequest::set_has_lock() {
  _has_bits_[0] |= 0x00000004u;
}
void ReadRequest::clear_has_lock() {
  _has_bits_[0] &= ~0x00000004u;
}
void ReadRequest::clear_lock() {
  lock_ = false;
  clear_has_lock();
}
 bool ReadRequest::lock() const {
  // @@protoc_insertion_point(field_get:azino.txindex.ReadRequest.lock)
  return lock_;
}
 void ReadRequest::set_lock(bool value) {
  set_has_lock();
  lock_ = value;
