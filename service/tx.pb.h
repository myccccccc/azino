...
enum TxOpStatus_Code {
  ...
  TxOpStatus_Code_Conflicts = 1,
  TxOpStatus_Code_TooLate = 2,
  TxOpStatus_Code_Block = 3,
  TxOpStatus_Code_NotExist = 4,
  TxOpStatus_Code_PartitionErr = 5
};
...
class TxOpStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:azino.TxOpStatus) */ {
 public:
  ...
  static const Code Ok =
    TxOpStatus_Code_Ok;
  static const Code Conflicts =
    TxOpStatus_Code_Conflicts;
  static const Code TooLate =
    TxOpStatus_Code_TooLate;
  static const Code Block =
    TxOpStatus_Code_Block;
